...
function renderHtml(page, pages) {
  ...
  const primaryContent =
    isContactPage
      ...
      : isAsSeenOnPage
        ? `<p>${escapeHtml(page.intro)}</p><div class="as-seen-grid">
            <section class="as-seen-card"><span class="as-seen-label">Directory listing</span><h2>Verified on Directree</h2><p>Find autoBlogger on Directree.</p><a href="https://www.directree.io" target="_blank" rel="noopener noreferrer" aria-label="Visit autoBlogger on Directree (opens in a new tab)"><img src="https://www.directree.io/badge/directree-badge-lightmode.svg" alt="Verified on Directree" width="200" height="37" loading="lazy" /></a></section>
            <section class="as-seen-card"><span class="as-seen-label">Directory listing</span><h2>Approved on SaaSHub</h2><p>Find autoBlogger on SaaSHub.</p><a href="https://www.saashub.com/autoblogger-bot?utm_source=badge&amp;utm_campaign=badge&amp;utm_content=autoblogger-bot&amp;badge_variant=color&amp;badge_kind=approved" target="_blank" rel="noopener noreferrer" aria-label="Visit autoBlogger on SaaSHub (opens in a new tab)"><img class="as-seen-saashub-image" src="https://cdn-b.saashub.com/img/badges/approved-color.png?v=1" alt="AutoBlogger.bot badge" loading="lazy" /></a></section>
            <section class="as-seen-card"><span class="as-seen-label">Shopify recognition</span><h2>Built for Shopify</h2><p>The Built for Shopify badge for autoBlogger.</p><a href="https://apps.shopify.com/autoblogger" target="_blank" rel="noopener noreferrer" aria-label="View autoBlogger on the Shopify App Store (opens in a new tab)"><img class="as-seen-shopify-image" src="/built-for-shopify-badge.png" alt="autoBlogger is officially Built for Shopify" width="619" height="619" loading="lazy" /></a></section>
          </div>`
      : isStaffPickPage

  ...
  return (
    isOpen && (
      <div className="md:hidden bg-white shadow-md py-2">
        ...
        <NavLink to="/other-apps" onClick={toggleMenu} className={({ isActive }) => `block px-4 py-2 ${isActive ? "font-semibold text-primary" : "text-gray-600"} hover:bg-gray-200`}>
          Other Apps
        </NavLink>
        ...
        <a href="/solutions" onClick={toggleMenu} className="block px-4 py-2 text-gray-600 hover:bg-gray-200">
          Solutions
        </a>
        <a href="/resources" onClick={toggleMenu} className="block px-4 py-2 text-gray-600 hover:bg-gray-200">
          Resources
        </a>
      </div>
    )
